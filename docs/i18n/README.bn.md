...
├── e-cat/           # রাস্ট ওয়ার্কস্পেস (ফ্রেমওয়ার্ক + ব্যবসায়িক পরিষেবা একসাথে)
│   └── ecat*/       # ফ্রেমওয়ার্ক ক্রেট এবং ব্যবসায়িক পরিষেবা (ecat · ecat-auth · ecat-gateway · ecat-device · ecat-access · ecat-rule · ecat-data-service · ecat-data-* …)
