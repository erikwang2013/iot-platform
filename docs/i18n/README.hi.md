...
├── e-cat/           # Rust वर्कस्पेस (फ्रेमवर्क + व्यावसायिक सेवाएँ एक साथ)
│   └── ecat*/       # फ्रेमवर्क क्रेट्स और व्यावसायिक सेवाएँ (ecat · ecat-auth · ecat-gateway · ecat-device · ecat-access · ecat-rule · ecat-data-service · ecat-data-* …)
