...
- [ ] **Step 3: 实现 ingest.rs（后台消费任务 + 批量 SQL）**
...
- [ ] **Step 3: 实现 api.rs（GET /api/data/history）**
...
- [ ] **Step 1: docker-compose 加 tdengine 服务**
...
- [ ] **Step 2: 写 proxy.rs（方法参数化转发 + 租户/secret 注入）**
